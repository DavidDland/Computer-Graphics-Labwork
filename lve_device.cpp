...
void LveDevice::createInstance() {
  ...
  // Set portability enumeration flag for MoltenVK/macOS
...
void LveDevice::createLogicalDevice() {
  ...
  // Make a mutable copy of deviceExtensions and add portability subset if needed
  std::vector<const char*> enabledExtensions = deviceExtensions;
  if (std::find(enabledExtensions.begin(), enabledExtensions.end(), std::string("VK_KHR_portability_subset")) == enabledExtensions.end()) {
...
std::vector<const char *> LveDevice::getRequiredExtensions() {
  ...
  // Add portability enumeration extension for MoltenVK/macOS
